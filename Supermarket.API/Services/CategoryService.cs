...
//services allow you to do multiple repository calls in case you need to combine data from different calls into one object
namespace Supermarket.API.Services
{
    public class CategoryService :ICategoryService
    {
        ...
        public async Task<CategoryResponse> DeleteAsync(int id)
        {
            ...
            {
                return new CategoryResponse($"An error occurred deleting the category: {ex.Message}");
            }
        }
    }
}